...
def main():
    ...
    LOGIN = os.getenv("TT_USERNAME")
    PASSWORD = os.getenv("TT_PASSWORD")
    BASE_URL = os.getenv("TT_API_URL") or "https://api.tastyworks.com"
    ...
    # Initialize TradingClient using the latest implementation
    # client = TradingClient(login=LOGIN, password=PASSWORD, base_url=BASE_URL)
